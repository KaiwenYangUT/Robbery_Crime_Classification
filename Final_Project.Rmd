...
plot_ly(merged_data_plot4_season, x = ~Season, y = ~`Total Crime Count`, type = 'bar', name = 'Total Crime Count') %>%
...
# Create a bar plot using plotly
plot_ly(merged_data_plot4_month, x = ~Month, y = ~`Total Crime Count`, type = 'bar', name = 'Total Crime Count') %>%
  add_trace(y = ~`Robbery Count`, name = 'Robbery Count', opacity = 0.5, text = ~paste(round(`Robbery Count`/`Total Crime Count` * 100, 2), "%"), hoverinfo = "text") %>%
...
# Create a bar plot using plotly
plot_ly(merged_data_plot4_day, x = ~Day_Of_Week_Numeric, y = ~`Total Crime Count`, type = 'bar', name = 'Total Crime Count') %>%
  add_trace(y = ~`Robbery Count`, name = 'Robbery Count', opacity = 0.5, text = ~paste(round(`Robbery Count`/`Total Crime Count` * 100, 2), "%"), hoverinfo = "text") %>%
...
# Create a bar plot using plotly
plot_ly(merged_data_plot4_hour, x = ~Hour, y = ~`Total Crime Count`, type = 'bar', name = 'Total Crime Count') %>%
  add_trace(y = ~`Robbery Count`, name = 'Robbery Count', opacity = 0.5, text = ~paste(round(`Robbery Count`/`Total Crime Count` * 100, 2), "%"), hoverinfo = "text") %>%
