...
The geographical distribution of robbery incidents across Toronto is shown in Figure 5. Each marker on the map represents a small geographic grid of robbery incidents, with color indicating the type of premises where incidents occurred.
