...
local_file <- "data/Income_Dataset.xlsx"
...
<div class="hero-grid">
<div class="hero-copy">
<div class="hero-kicker">Modeling</div>

# Statistical Model

<p class="hero-lead">This section compares several classification approaches for identifying robbery incidents using temporal, spatial, and neighbourhood-level predictors. The goal is to evaluate which models offer the strongest predictive performance and the clearest interpretation of robbery risk.</p>
</div>
</div>
</div>
